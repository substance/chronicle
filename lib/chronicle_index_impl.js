...
IndexImpl.__prototype__ = function() {
  ...
  this.shortestPath = function(start, end) {
    ...
    // trivial cases
    if (start === end) return [];
    if (end === ROOT) return __private__.getPathToRoot.call(this, start);
    if (start === ROOT) return __private__.getPathToRoot.call(this, end).reverse();
...
TmpIndex.__prototype__ = function() {
  ...
  this.getChildren = function(id) {
    var result =  result = __super__.getChildren.call(this, id) || [];
