...
TextOperation.__prototype__ = function() {
  ...
  this.transform = function(other, check) {
    return TextOperation.transform(this, other, check);
  };

  this.hasConflict = function(other) {

    if (other instanceof TextOperation.Compound) {
...
TextOperation.transform = function(a, b, options) {

  options = options || {};

  if (a instanceof TextOperation.Compound || b instanceof TextOperation.Compound) {
    return TextOperation.Compound.transform(a, b, options);
  }
...
// A special version of a text operation that represents
// an ordered sequence of primitive operations.
TextOperation.Compound = function() {
  // TODO implement
};
