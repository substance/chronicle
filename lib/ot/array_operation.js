...
ArrayOperation.__prototype__ = function() {
  ...
  this.transform = function(other, check) {
    return ArrayOperation(this, other, check);
  };

  this.hasConflict = function(other) {

    if (other instanceof ArrayOperation.Compound) {
      return other.hasConflict(this);
    }
...
ArrayOperation.transform = function(a, b, options) {

  options = options || {};

  if (a instanceof ArrayOperation.Compound || b instanceof ArrayOperation.Compound) {
    return ArrayOperation.Compound.transform(a, b, options);
  }
...
// A special version of array operations that is
// a ordered sequence of primitive operations.
ArrayOperation.Compound = function() {
  // TODO implement
};
