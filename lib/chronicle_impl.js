...
ChronicleImpl.__prototype__ = function() {
  ...
  this.merge = function(id, strategy, options) {
    ...
    if (strategy === "mine") {
      ...
      var reverts1, reverts2, applies1, applies2;
      var tmp1, tmp2;
      ...
      if (sequence.length === 0) {
        ...
        reverts1 = diff1.reverts();
        reverts2 = diff2.reverts();
        ...
        tmp1 = this.index.diff(head, sequence[0]);
        tmp2 = this.index.diff(id, sequence[0]);
        reverts1 = tmp1.reverts();
        reverts2 = tmp2.reverts();
        applies1 = tmp1.applies().concat(sequence.slice(1));
        applies2 = tmp2.applies().concat(sequence.slice(1));
